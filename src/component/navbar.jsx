...
function NavBar() {
    ...
    return (
        <nav
            className="flex-wrap flex gap-2 bg-[url('https://media.istockphoto.com/id/1200924718/fr/vectoriel/banni%C3%A8re-de-griffonnage-dessin%C3%A9e-%C3%A0-la-main-dartiste-illustrations-d%C3%A9taill%C3%A9es-de-dessin.jpg?s=612x612&w=0&k=20&c=rCqWHjHl7MY0Tder4jLeoqBNbvF8TZTvMMIq8Yp1xvU=')]">
            <NavLink to={"/"}>
                <img
